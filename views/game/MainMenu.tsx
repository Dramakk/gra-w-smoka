    ...
    <div className="menu">
      ...
      <SlideDown opened={infoDisplay}>
        <div className="game-description">
          ...
          <br />
          <div>
            Celem gry jest otwarcie wyjścia oraz doprowadzenie do niego smoka.
            Po ukończeniu poziomów dla początkujących, jedyną podpowiedzią dla
            gracza jest nazwa poziomu oraz dostępne gadżety, co dodatkowo
            podnosi trudność łamigłówek.
          </div>
          <br />
          <div>
