...
export default function EditorForm (): React.ReactElement {
  ...
  function handleBlur (
    ...
    if (newValue > 25) return setFunction(25)
    setFunction(newValue)
  }
    ...
    <div className="editor-form">
      <div className="editor-form-row">
        ...
        <input
          ...
          type="number"
          value={howManyRows || ''}
          onBlur={(e) => handleBlur(e, changeHowManyRows)}
          onChange={(e) => handleChange(e, changeHowManyRows)}
        ></input>
      </div>
      <div className="editor-form-row">
        ...
        <input
          ...
          type="number"
          value={howManyPerRow || ''}
          onBlur={(e) => handleBlur(e, changeHowManyPerRow)}
          onChange={(e) => handleChange(e, changeHowManyPerRow)}
        ></input>
      </div>
      <button
        className={!howManyPerRow || !howManyRows ? 'button-disabled' : ''}
        disabled={!howManyPerRow || !howManyRows}
